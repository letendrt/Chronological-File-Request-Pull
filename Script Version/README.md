...
1) Start by downloading the [Chrono_Pull_Script_Version.py](https://github.com/letendrt/Chronological-File-Request-Pull/blob/main/Script%20Version/Chrono_Pull_Script_Version.py) attached in this repository folder.
